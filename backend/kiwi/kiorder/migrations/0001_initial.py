    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('franchise', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='kiorder.Franchise')),
                ('purchasables', models.ManyToManyField(to='kiorder.Purchasable')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(choices=[('waiting', 'Waiting'), ('doing', 'Doing'), ('done', 'Done')], default='waiting', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('state', models.CharField(choices=[('ready', 'Ready'), ('done', 'Delivered'), ('cancelled', 'Cancelled'), ('rollback', 'Rolled back')], default='ready', max_length=16)),
                ('store', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='kiorder.Store')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='kiorder.PurchasableOption'),
        ),
        migrations.AddField(
            model_name='purchasable',
            name='user',
