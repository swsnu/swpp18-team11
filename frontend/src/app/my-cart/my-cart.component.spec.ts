...
describe('MyCartComponent', () => {
  ...
  it('updateMyCart should set myCart and updateTotalPrice', ()=>{
    let testMyCartAnother = [testPurchasable]
  ...
  it('hasOptions should check Purchasable options', ()=>{
    // option undefined
    let optionUndefinedPurchasable = new Purchasable({
    ...
    // has potions
    let optionPurchasable = new Purchasable({
  ...
  it('updateOptionChange should update purchasable options', ()=>{
    let newOptions: Option[] = [new Option({total_price: 100})]
